...
我们可以这样理解：'c1'线程获得了'bank'对象的锁之后，由于'bank'对象是静态的，属于'Mbank'类，所以是唯一的，那对象锁只有一个，'c2'线程只能等待锁被释放掉，才能去访问'bank'对象中被`synchronized`标记或者说保护起来的共享资源。
...
**所以，要理解'互斥锁'的含义，它锁的是一个实例化对象，一个对象只有一个互斥锁，利用这种对锁的争夺，就可以实现不同线程间的互斥效果了。**
